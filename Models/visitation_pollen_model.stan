...
model {	
	...
	// flwCount ~ neg_binomial_2_log(flwCountMu,flwCountPhi); //Flower count per plant (attempted pods) - NB version	
	logFlwCount ~ normal(flwCountMu,sigmaFlwCount); //Flower count per plant (attempted pods) - lognormal version
