...
parameters {
	//Claim 12: seedCount ~ field edge
	real slopeHbeeDistSeedCount; //Direct effect of (log) field edge distance
...
transformed parameters {			
	...
	for(i in 1:Nplant){
		...
		seedCountMuPlant[i] = intSeedCount + intSeedCount_field[plotIndex[plantIndex[i]]] + intSeedCount_plot[plantIndex[i]] + intSeedCount_plant[i] + 
			...
			slopeHbeeDistSeedCount*(logHbeeDist_all[plantIndex[i]]); //Claim		
