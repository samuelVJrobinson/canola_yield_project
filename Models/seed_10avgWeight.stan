...
model {
  ...
  // print(" phiPollen: ",phiPollen);
  // print(" seedMass: ",seedMass);
  // print(" seedWeightMu: ",seedWeightMu);
  // print(" sigmaSeedWeight: ",sigmaSeedWeight);
  // print(" lambdaSeedWeight: ",lambdaSeedWeight);
  // print(" test lpdf: ",exp_mod_normal_lpdf(3.41|0,5,1));
  
  // for(i in 1:Nflw){
  //   print("pollen lpmf",i,": ",neg_binomial_2_log_lpmf(pollenCount[i] | pollenMu[i],phiPollen));
  // }
  
  // for(i in 1:Nplant){
  //   print("seedWeight lpdf",i,": ",exp_mod_normal_lpdf(seedMass[i] | seedWeightMu[i],sigmaSeedWeight, lambdaSeedWeight));
  // }
	...
	// seedMass ~ normal(seedWeightMu,sigmaSeedWeight); //Weight per seed	- exp.normal version
