...
parameters {
	//Claims: seedWeight ~ flDens
	real slopeFlDensSeedWeight;	
...
transformed parameters {
	...
	for(i in 1:Nplant){	
		...
		seedWeightPlantMu[i] = intSeedWeight + 
			...
			slopeFlDensSeedWeight*flDens[plantIndex[i]] + //Claim
...
model {	
	...
	// Priors
	// Claims
	slopeFlDensSeedWeight ~ normal(0,5);	
	slopeHbeeDistSeedWeight ~ normal(0,5); //Conditioning set
