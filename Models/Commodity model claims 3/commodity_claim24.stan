...
vector[Nplot] flwCountPlot; //Plot-level flowers per plant
    ...
    flwCountPlot[i] = intFlwCount + //Intercept
      claim24_hbeeVisFlwCount*logHbeeVis[i] + //Claim
      slopeFlDensFlwCount*flDens[i] + //Other claim
      slopeHbeeDistFlwCount*logHbeeDist[i] + //Other claim
      slopeNumHivesFlwCount*logNumHives[plotIndex[i]] + //Other claim
