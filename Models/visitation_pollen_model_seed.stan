...
parameters {
	...
	real<lower=0.01> sigmaPlSize_field; //Sigma for field
	real<lower=0.01> sigmaPlSize_plot; //Sigma for plot
	real<lower=0.01> sigmaPlSize; //Sigma for within-plot (residual)
