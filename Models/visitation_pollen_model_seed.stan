data { 
	...
	int Nplot_plDensMiss; //Number of plots with plant density missing (about 40% - male bays)
	vector[Nplot_plDensObs] plDens_obs; //Observed plant density (stems/m2)
	int<lower=1,upper=Nplot> obsPlDens_ind[Nplot_plDensObs]; //Index for observed plant density
	int<lower=1,upper=Nplot> missPlDens_ind[Nplot_plDensMiss]; //Index for missing plant density	
...
parameters {
	...
	vector[Nplot_plDensMiss] plDens_miss; //Missing plant density
