...
parameters {
	...
	// real<lower=1e-05,upper=1> zeroVisHbeeTheta; //Zero-inflation parameter - chance that zero is not from neg.bin. 
	...
	// real slopeStockingLbeeDistLbee; //Half-stocking:lbee distance interaction
...
// generated quantities {
	...
	// real<lower=1e-05> predFlwCount[Nplant]; //Generated
