...
# plants=summarise_each(group_by(seeds,Field,BagNum),funs(mean,se)) %>%
...
# 
# # Save workspace
# save.image("C:\\Users\\Samuel\\Documents\\Projects\\UofC\\Seed field analysis\\seedfieldData2016.RData")
