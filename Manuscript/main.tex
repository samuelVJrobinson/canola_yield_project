...
% Ultimately this depends on the distance from the source of pollination, the efficacy of the pollinator, and the extent to which the plant is limited by nutrients or pollination.
...
%Comments from SP:
% - Could directly contrast results to those of Sabbahi et al 2005, who found 46% increase in yield at 3 colonies/ha
% - What might the next steps be for testing recommendations in seed fields? LCBs only? Varietal differences? Bay sizes?

%Comments from RC:
% - Include rug plot in figures? (can't included "adjusted" data points, as this is impossible for GLMs)
...
Colonies of Western honey bees (\emph{Apis mellifera} L., hereafter HB) were located at the corner or side of 28 of the 60 fields (stocking rates: 0.03 - 3.1 hives/ha while 32 fields were unstocked. %range: 0.03 - 3.1 hives/ha, mean: 0.6, sd: 0.58 Apiaries were stationed at the edges of fields, often near to shrubs or tree-lines to act as a wind break.
...
All surveys occurred on fair-weather days (median temperature: 24.5$^\circ$C., range: 17--33$^\circ$C.) with no rain and minimal wind ($>$30 km/hr); wind speed and temperature were measured at each site with a Kestral\texttrademark 2500 weather meter.
...
% Plots were marked with coloured stakes driven into the soil to locate them later in the season. %Full paper should have a table of climate variables.
...
We dryed and weighed each plant, counted mature pods to estimate pod set, and counted flower pedicels to estimate total flower production. % at 50$^\circ$C
We estimated seed size and seeds per pod by averaging the seed count and weight from five pods on each plant.
Finally, we threshed all the pods for each plant by hand, winnowed them using an air separator, and weighed the total mass of cleaned seeds (hereafter ``plant yield"). % (3872 commodity canola pods, 2885 seed canola pods)
...
% \begin{itemize}
% 	\item HB visitation depends on distance from their hive
%     \item Pollen deposition depends on HB visitation
...
% \begin{itemize}
% 	\item HB visitation depends on distance from edge of field (proxy for distance from hives), bay position, bay type, and distance to leafcutter shelter
%     \item leafcutter bee visitation depends on distance from their shelter, bay position, and bay type
%     \item Pollen deposition depends on HB and leafcutter visitation
%     \item Seeds per pod depends on pollen deposition
...
% HB visitation decreased with distance from the edge of the field in both commodity and seed canola, and increased with distance from LCB shelters; interestingly, LCB visitation also decreased with distance from the edge of the field in seed fields.
...
Pollen deposition also decreased from 15 grains/stigma at the edge of the female bay to 9 at the centre of the bay independent of visitation (Figure \ref{fig:allPollen}c), suggesting that bees crossing over into the male bays may deposit less pollen as they move towards the centre.% \citep{pinnisch1990}.%, who likely visit flowers at the edge of the bay first. 
% Flies were also common visitors in commodity fields (Table \ref{tab:propVisitors}), but had no effect on pollen deposition (p$=$0.577), so only HBs and LCBs were considered as potential pollinators (other flower visitors were rare).
...
% We examined how bee visitation contributes to pollen deposition and seed yield in two different canola crops, and
...
% This runs contrary to other studies in commodity canola (\citealp{sabbahi2005}, but see \citealp{garibaldi2013} and \citealp{waytes2022}), so why did 
...
This work was supported by the Alberta Crop Industry Development Fund (#20014C001R), the Alfalfa Seed Commission Fund, the Canadian Bee Research Fund, and the Alberta Beekeepers Commission.
We thank our tireless field assistants, Breannalee Beer, Zac Wagman, Chris Isaacs, Ian Johnson, Krista Fjordbotten, Jeff Kearns, Sam Knight, and Haley Shade. 
We also thank Megan Abarmayan, Shahid Majid, Mohamed Ibrahim, Ashley Londeau, and Joseph Desmarais, for their additional help with processing plants and flower stigmas, and Lynae Ovinge for her support in the lab.
Thanks to Ria van Giessen, Alfonso Parra, and Miki Miheguli at BASF for giving us access to their seed fields in 2015. 
Finally, many thanks to the farmers who gave us access to their land for this study, in particular: Dave Hofer, Ron Lamb, Dave McKee, Gord and James Graham, and many others.
