...
Seed fields were stocked with honey bee hives at a rate of 3.6 hives/ha, with apiaries stationed in the corners of fields, and were also stocked with LCBs in shelters throughout the field (1.3 or 2.6 shelters/ha).
...
In both fields, we established set of plots at varying distance from the sources of pollinators. 
In commodity fields, we established 1 m$^2$ plots at 5, 20, 100, and 500m, starting at the field margin closest to the set of honey bee hives %(271 total plots), 
and established plots starting at potential sources of natural pollinating insects in unstocked fields (forests, shrublands, or grasslands), but observed very few wild pollinators (Table \ref{tab:propVisitors}).
In seed canola fields, bays of hermaphroditic (herafter ``male") and female plants are typically planted in 1- and 6-m wide bays, respectively, and LCB shelters were located in the female bays (Figure \ref{fig:seedfieldPhoto}, \ref{fig:seedfieldPlots}).
...
We established another plot in the centre of the female bay at the 5m and 400m plot in each field to examine how visitation varied within the female bay.
...
Interactions between predictors were evident in honey bee visitation rate (Year:Locality interaction) and plant density (Irrigation:Year) in commodity canola, and for LCB visitation (Tent Stocking:Distance from edge) in seed canola, and were included in each model (represented as Y-shaped path in Figures \ref{fig:commoditySEM} and \ref{fig:seedSEM}). 
...
Honey bee visitation was lower near leafcutter shelters (Z=3.9, p$=$0.001), dropping from 60 visits/hr at 10 m to 34 visits/hr at 2 m, likely due to competition with LCBs (Figure \ref{fig:hbeeDist_both}, \ref{fig:lbeeDist_both}).

LCB visitation declined rapidly with distance from their shelters (Z=-11.4, p$=$0.0001, 75\% reduction in 10 m), and unexpectedly, was higher at the edge of the field than the centre (Z=-4.4, p$=$0.0001, 114 visits/hr vs 28 visits/hr). %350 visit/hr at 2 m to 83 visit/hr at 10 m
...
There was no difference in visitation rates between the male bay and the edge of the female bays (LCB: p$=$0.72, honey bee: p$=$0.32). 
However, LCB visitation was lower in the centre of the female bay (p$=$0.04, 51 vs. 29 visits/hr), and honey bee visitation was higher at the centre of the bay (p$=$0.008, 71 vs. 117 visits/hr, Figure \ref{fig:edgeCentVis_both}).
...
In seed canola, pollen deposition was much lower overall (mean: 22 grains per stigma, SD: 43, range: 0--578), LCB visitation had a strong positive effect (Z=3.2, p$=$0.002, Figure \ref{fig:visPol_both}, 12 grains/stigma at 6 visits/hr vs. 16 pollen grains at 60 visits/hr), and was lower at the centre of the field (Z=-4.4, p$=$0.0001, Figure \ref{fig:distCentPol}, 23 vs. 11 grains/stigma).
