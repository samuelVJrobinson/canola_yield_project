...
Finally, we threshed all the pods for each plant by hand, winnowed them using an air separator, and weighed the total mass of cleaned seeds (hereafter ``yield"). % (3872 commodity canola pods, 2885 seed canola pods)
