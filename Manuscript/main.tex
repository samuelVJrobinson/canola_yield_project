...
p-values were calculated using the Z-scores (mean/SD) of the sampled posterior distributions; unless otherwise specified, p-values are lower than 0.05 (see Table \ref{tab:commCoef} and \ref{tab:seedCoef} for more detailed model summaries). 
