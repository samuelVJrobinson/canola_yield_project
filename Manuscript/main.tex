...
%REVIEW THIS
The limited pollen-transferring behaviour of HBs was also reflected in the pollen counts, as deposition strongly increased with LCB visitation, but not with HB visitation.
...
Extra pollination generally results in canola plants producing more, smaller-sized seeds (see review in \citealt{ouvrard2019}, but see also \citealtt{koltowski2005}), as the plant re-allocates resources across a greater number of fertilized ovules.
