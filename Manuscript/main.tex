...
Plant size increased pod set in commodity canola, but both plant size and pollen increased pod set in seed canola, suggesting that both pollen deposition and plant resources constrain pod production.
...
Plant size increased seeds per pod in both crop types, but the number of seeds per pod in seed canola was also increased by pollen deposition and pod set. 
...
\citet{mesquida1982} also found that pod production, rather than seeds per pod, was the main variable controlled by pollen deposition in seed canola.
...
Seed size was influenced by plant size in seed canola, but not commodity canola, and was not influenced by pollen or visitation in either crop \citep{riffkin2012}.
